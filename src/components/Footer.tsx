        ...
        <div className="py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-white/70 mb-4">
              Мебель в индустриальном стиле из металла и дерева. Создаем мебель
              для дома, офисов, ресторанов и кафе.
            </p>
            <div className="flex space-x-4">
              <a
                ...
                className="text-white hover:text-loft-green transition-colors"
              >
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a
                  href="#"
                  className="text-white/70 hover:text-loft-green transition-colors"
                >
                  Главная
                </a>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                <Icon
                  name="MapPin"
                  className="h-5 w-5 text-loft-green mr-3 mt-0.5 shrink-0"
                />
              ...
              <li className="flex items-center">
                <Icon
                  name="Phone"
                  className="h-5 w-5 text-loft-green mr-3 shrink-0"
                />
                <a
