...
const products = [
  {
    ...
    category: "Столы",
    price: 32900,
    image: "https://images.unsplash.com/photo-1530018607912-eff2daa1bac4?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2071&q=80",
    isNew: true,
    isBestseller: false
  },
  {
  ...
  {
    id: 4,
    name: "Светильник ЭДИСОН",
    category: "Освещение",
    price: 8900,
    image: "https://images.unsplash.com/photo-1573966789363-e6a902e473ff?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1074&q=80",
    isNew: true,
    isBestseller: false
  }
];
          ...
          {products.map((product) => (
            ...
            >
              ...
              <div className="relative h-60 overflow-hidden">
                {(product.isNew || product.isBestseller) && (
                  <div className="absolute top-3 left-3 z-10">
                    {product.isNew && (
                      <Badge className="bg-loft-red text-white border-none mb-2 block">Новинка</Badge>
                    )}
                    {product.isBestseller && (
                      <Badge className="bg-loft-black text-white border-none block">Хит продаж</Badge>
                    )}
                  </div>
                )}
                <img 
              ...
              <div className="p-4 flex flex-col flex-grow">
                <span className="text-sm text-loft-black/60 mb-1">{product.category}</span>
                <h3 className="text-lg font-bold text-loft-black mb-2 font-heading">{product.name}</h3>
