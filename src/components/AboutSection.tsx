        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="animate-slideUp">
            ...
            <p className="text-white/80 mb-6">
              Мастерская ТОМЛОФТ — это команда профессионалов, которые создают
              уникальную мебель в стиле лофт. Мы сочетаем индустриальную
              эстетику с функциональностью, создавая предметы, которые
              становятся центральными элементами в интерьере.
            </p>

            <p className="text-white/80 mb-8">
              Каждое изделие изготавливается вручную в нашей мастерской в
              Санкт-Петербурге. Мы используем только высококачественные
              материалы: прочную сталь и натуральное дерево, обрабатываем их
              современными способами для достижения идеального результата.
            </p>

            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
              <div className="text-center">
                <div className="text-loft-green font-bold text-4xl mb-2 font-heading">
                  7+
                </div>
            ...
            <Button className="bg-loft-green hover:bg-loft-green/90 text-white rounded-sm">
              Подробнее о нас
