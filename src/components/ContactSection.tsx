      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center mb-12">
          ...
          <p className="text-white/70 text-center max-w-2xl">
            Остались вопросы или готовы сделать заказ? Свяжитесь с нами любым
            удобным способом
          </p>
        </div>
            ...
            <div className="bg-loft-gray p-8 rounded-md">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  <div className="bg-loft-green rounded-full w-10 h-10 flex items-center justify-center mr-4 shrink-0">
                    <Icon name="MapPin" className="h-5 w-5 text-white" />
                  </div>
                  <div>
                    <h4 className="text-white font-bold mb-1">Адрес</h4>
                    <p className="text-white/80">
                      Санкт-Петербург, Сертолово
                      <br />
                      ул. Тихвинская, 12
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-white/80">
                      <a
                        ...
                        className="hover:text-loft-green transition-colors"
                      >
                        8 (981) 947-40-96
                      </a>
                    </p>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-white/80">
                      <a
                        href="mailto:elenamaslivec@mail.ru"
                        className="hover:text-loft-green transition-colors"
                      >
              ...
              <form className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label
                      htmlFor="name"
                      className="block text-sm font-medium text-loft-black/80 mb-1"
                    >
                      Имя
                    </label>
                    <Input
                      ...
                      className="border-loft-black/20 focus:border-loft-green"
                      required
                    />
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    className="border-loft-black/20 focus:border-loft-green min-h-[120px]"
                    required
                  />
                </div>
                ...
                <Button
                  type="submit"
                  className="w-full bg-loft-green hover:bg-loft-green/90 text-white rounded-sm py-6"
                >
                  Отправить сообщение
                </Button>
              </form>
